...
import { AuthorizedNavBar } from "../../Component/NavBar/AuthorizedNavBar"
import { DriverIndex } from "../../Component/Driver/DriverIndex"
...
const data:NavigationBarData[]=[
{icon:'',imageUrl:'',userName:''}
];
return(
<>
