...
<div className="row g-0 col-sm-5 mb-4">
...
<div className="table-responsive m-auto">
    ...
    >
        <thead className="table-light">
            <tr>
                <th colSpan={3} className='px-4'><Link to={'hospital/0/add'} type="button" className="btn btn-outline-primary  rounded-pill px-2 border-3 py-1 my-3">
                    <i className="bi bi-plus" aria-hidden="true"></i></Link> 
                </th>
            </tr>
            <tr>
                <th colSpan={3} className='fs-3 px-5 fw-bolder'>List of Available Hospital</th>
            </tr>
            <tr>
                <th>Name</th>
                <th>Location</th>
        ...
        <tbody className="table-group-divider">
            {
                data.map((data,index)=>{
                    return(
                        <tr className="table-primary" key={index+'s'}>
                            <td key={index+'s'} scope="row"><i className="bi bi-hospital-fill"></i> {data.name}</td>
